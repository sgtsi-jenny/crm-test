                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        <div class='col-ms-12 text-right'>
                          <a href='frm_tax_status.php' class='btn btn-success'> Create New <span class='fa fa-plus'></span> </a>
                        </div>
                        <br/>
                            ...
                            ?>
                              <tr>
                                ...
                                <td class='text-center'>
                                  <a href='frm_tax_status.php?id=<?php echo $row['id']?>' class='btn btn-success btn-sm'><span class='fa fa-pencil'></span></a>
